...
const Services = () => {
    ...
    return (
        <div id="services" className="relative bg-gradient-to-b from-sky-50 to-white py-16">
            <div className="max-w-6xl mx-auto px-4">
                <h2 className="text-3xl font-bold text-center mb-12 border-b border-sky-200 pb-4">Our Services</h2>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service, index) => (
                        <div key={index} className="bg-white rounded-lg overflow-hidden hover:shadow-lg transition-shadow border border-gray-100">
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-semibold mb-2 text-sky-900">{service.title}</h3>
